...
import DownLoadIMG from "/src/assets/download-minimalistic-svgrepo-com.svg"; // Adjust the import path
...
function Photo(props) {
  ...
  return (
    <>
      ...
      <section
        className="mx-5 md:mx-12 grid grid-cols-2 md:grid-cols-3
